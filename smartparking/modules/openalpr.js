...
const opts = {
    ...
    'state': "EU", // {String} Corresponds to a US state or EU country code used by OpenALPR pattern  recognition.  For example, using \"md\" matches US plates against the  Maryland plate patterns.  Using \"fr\" matches European plates against  the French plate patterns.
...
function openAlpr() {
    function callImg(imageUrl, next, err) {
        ...
        api.recognizeBytes(imageUrl, secretKey, country, opts, callback);
    }
